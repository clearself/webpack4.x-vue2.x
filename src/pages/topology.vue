...
export default {
    ...
    data() {
        return {
            ...
            nodeTypeList: [
                { guid: 'server', label: '服务器', imgSrc: require('@/assets/img/server.png') },
                { guid: 'database', label: '数据库', imgSrc: require('@/assets/img/database.png') },
                { guid: 'firewall', label: '防火墙', imgSrc: require('@/assets/img/firewall.png') },
                { guid: 'client', label: '客户端', imgSrc: require('@/assets/img/client.png') }
            ],
            // 节点配置
            nodeAppConfig: {
                ip: '节点IP',
    ...
    methods: {
        ...
        getRelatedData() {
            ...
            console.log('randomNodeIds', randomNodeIds)
